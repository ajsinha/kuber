...
- **Secondary Indexing (v1.9.0)**: O(1) hash and O(log n) B-tree indexes for 100-1000x faster JSON searches
- **Hybrid Index Storage (v1.9.0)**: In-memory indexes for speed + RocksDB persistence for durability
...
### Request/Response Logging (v1.9.0)
