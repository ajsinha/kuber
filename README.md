...
- **Secondary Indexing (v1.8.2)**: O(1) hash and O(log n) B-tree indexes for 100-1000x faster JSON searches
- **Hybrid Index Storage (v1.8.2)**: In-memory indexes for speed + RocksDB persistence for durability
...
3. **Run Kuber**
   ...
   java --add-opens=java.base/java.nio=ALL-UNNAMED \
        ...
        -jar kuber-server/target/kuber-server-1.8.2.jar
   ```
...
### Request/Response Logging (v1.8.2)
