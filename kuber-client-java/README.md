...
**v2.5.0**: API Key Authentication Required - All programmatic access now requires an API key.
...
```groovy
implementation 'com.kuber:kuber-client:2.5.0'
```
...
// v2.5.0: API key authentication required
