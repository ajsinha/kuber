/*
 * Kuber REST API - Generic Search Demo (v1.9.0)
 *
 ...
 *
 * Example:
 *     java RestGenericSearchDemo localhost 8080 kub_admin
 *
...
public class RestGenericSearchDemo {
    ...
    private void demoRegexKeySearch(String region) throws IOException {
        printHeader("10. REGEX KEY SEARCH (v1.9.0 - REST API)");

        System.out.println("""
    
    New in v1.9.0: Two dedicated REST endpoints for regex-based key search:
    ...
    public void runDemo(String region) {
        try {
            ...
            demoRegexKeySearch(region);  // New in v1.9.0
...
This demo showcased all Generic Search API capabilities:
  ...
  7. REGEX KEY SEARCH (v1.9.0 - REST API only)
...
API Endpoints:
  ...
  - Key Search:     GET /api/cache/{region}/ksearch
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=".repeat(80));
        System.out.println("  KUBER REST API - GENERIC SEARCH DEMO (v1.9.0) - Java");
        System.out.println("=".repeat(80));
