...
| Confluent Kafka | Event publishing & messaging (Cloud/Platform) | Confluent Cloud or Platform |
| RabbitMQ | Event publishing & messaging | AMQP messaging |
| ActiveMQ | Event publishing & messaging | JMS messaging |
| IBM MQ | Event publishing & messaging | Enterprise MQ |
...
| `confluent-kafka` | `bootstrap_servers`, `api_key`, `api_secret`, `group_id` |
