...
```
kuber-server/target/kuber-server-2.5.0.jar
```
...
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED \
     -jar kuber-server/target/kuber-server-2.5.0.jar
...
KUBER_JAR="${KUBER_HOME}/kuber-server-2.5.0.jar"
