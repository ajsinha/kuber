...
```
kuber-server/target/kuber-server-1.7.6-SNAPSHOT.jar
```
...
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED \
     -jar kuber-server/target/kuber-server-1.7.6-SNAPSHOT.jar
...
KUBER_JAR="${KUBER_HOME}/kuber-server-1.7.6-SNAPSHOT.jar"
...
```bash
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED \
     -jar kuber-server-1.7.6-SNAPSHOT.jar
```
