...
### 5. JSON Attribute Search (v1.9.0 Enhanced)
...
| `criteria` | Object | No | JSON search criteria (v1.9.0) |
...
| Version | Changes |
|---------|---------|
| 1.9.0 | Added multi-key, multi-pattern, and enhanced JSON criteria search |
