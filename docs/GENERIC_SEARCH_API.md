...
### 5. JSON Attribute Search (v1.7.9 Enhanced)
...
| `criteria` | Object | No | JSON search criteria (v1.7.9) |
...
| Version | Changes |
|---------|---------|
| 1.7.9 | Added multi-key, multi-pattern, and enhanced JSON criteria search |
