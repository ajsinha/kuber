...
### 5. JSON Attribute Search (v1.7.7 Enhanced)
...
| `criteria` | Object | No | JSON search criteria (v1.7.7) |
...
| Version | Changes |
|---------|---------|
| 1.7.7 | Added multi-key, multi-pattern, and enhanced JSON criteria search |
