...
### 5. JSON Attribute Search (v1.8.3 Enhanced)
...
| `criteria` | Object | No | JSON search criteria (v1.8.3) |
...
| Version | Changes |
|---------|---------|
| 1.8.3 | Added multi-key, multi-pattern, and enhanced JSON criteria search |
